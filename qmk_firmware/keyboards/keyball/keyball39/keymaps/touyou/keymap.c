...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_universal(
    ...
    KC_LCTL, KC_LSFT, KC_LALT, LGUI_T(KC_LNG2), LT(1,KC_SPC), LT(3,KC_TAB),    LT(2,KC_BSPC), RGUI_T(KC_LNG1), XXXXXXX, XXXXXXX, XXXXXXX, LT(4,KC_ESC)
  ),
  ...
  [1] = LAYOUT_universal(
    ...
    KC_LSFT, _______, _______, _______, _______, MO(3),    _______, MO(3), XXXXXXX, XXXXXXX, XXXXXXX, _______
  ),
  // Layer 2: Mouse layer
  [2] = LAYOUT_universal(
    ...
    KC_PDOT, _______, _______, _______, _______, MO(3),    _______, _______, XXXXXXX, XXXXXXX, XXXXXXX, _______
  ),
  // Layer 3: Function & Scroll layer
  [3] = LAYOUT_universal(
